...
void handleAddCard({required BuildContext context, String ? title, String ? cardNumber, String ? expiryDate, String ? cvv}) async
{
  if (cardNumber == "") {
    ...
    (title == null) ? Navigator.pushNamed(context, 'bottom-nav-bar-menu/') : Navigator.pushNamed(context, 'my-payment/');
  }
}